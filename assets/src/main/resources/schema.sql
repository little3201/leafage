...
COMMENT
ON COLUMN file_records.superior_id IS '上级ID';
COMMENT
...
COMMENT
ON COLUMN file_records.directory IS '是否文件夹';
COMMENT
ON COLUMN file_records.regular_file IS '是否文件';
COMMENT
ON COLUMN file_records.symbolic_link IS '是否软链';
COMMENT

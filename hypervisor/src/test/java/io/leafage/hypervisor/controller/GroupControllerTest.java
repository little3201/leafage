...
class GroupControllerTest {
    ...
    void fetch_error() throws Exception {
        ...
        mvc.perform(get("/groups/{id}", anyLong())).andExpect(status().isNoContent())
                .andDo(print()).andReturn();
    }
    ...
    void remove() throws Exception {
        ...
        mvc.perform(delete("/groups/{id}", anyLong()).with(csrf().asHeader())).andExpect(status().isOk())
                .andDo(print()).andReturn();
    }
    ...
    void remove_error() throws Exception {
        ...
        mvc.perform(delete("/groups/{id}", anyLong()).with(csrf().asHeader()))
                .andExpect(status().isExpectationFailed())
                .andDo(print()).andReturn();
    }
    ...
    void enable() throws Exception {
        ...
        mvc.perform(patch("/groups/{id}", anyLong()).with(csrf().asHeader()))
                .andExpect(status().isAccepted())
                .andDo(print()).andReturn();
    }
    ...
    void members_error() throws Exception {
        ...
        mvc.perform(get("/groups/{id}/members", anyLong())).andExpect(status().isNoContent())
                .andDo(print()).andReturn();
    }
